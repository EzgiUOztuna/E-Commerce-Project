...
export default function ProductDetailsPages() {
    ...
    return <>
        <SiteHeader />
        <div className='bg-[#FAFAFA] font-montserrat flex flex-col items-center lg:pb-0'>
            ...
            <div className='flex flex-col mx-auto items-center
                            lg:flex-row lg:pb-12 lg:gap-8 lg:items-start'>
                <div className='flex flex-col gap-4 rounded-md'>
                    <img src={selectedImage}
                        className='w-[348px]
                                   lg:w-[31rem] lg:h-[28rem]' />

                    <div className='flex items-center gap-4'>
                        {product.images.map((img, index) => (
                            <img className="w-28 h-20 
                                            lg:w-24 lg:h-20"
                                key={index}
                                src={img}
                ...
                <div className='flex lg:flex-col'>
                    {productDetailsData.map((item, index) => (
                        <div key={index}
                            className='flex flex-col w-[21.75rem] px-6 lg:w-[32rem] lg:h-[27.8rem] lg:px-0'>
                            <h4 className='font-normal text-xl leading-8 tracking-[0.2px] text-[#252B42] pb-3 pt-6 lg:pt-0'>{item.h4}</h4>
