                ...
                <div className='hidden
                    ...
                    <div className='hidden
                        ...
                        <div className='lg:flex lg:w-[9.063rem] lg:h-11 lg:items-center lg:gap-[0.313rem] lg:p-[0.625rem] lg:rounded-[0.313rem]'>
                            <img className='lg:w-4 lg:h-4' src="/icons/phone.svg"></img>
                        ...
                        <div className='lg:w-[16.25rem] lg:h-[2.75rem] lg:flex lg:items-center lg:gap-[0.3125rem] lg:p-[0.625rem] lg:rounded-[0.3125rem]'>
                            <img className='lg:w-4 lg:h-4' src="/icons/email.svg"></img>
                    ...
                    <div className='lg:flex lg:gap-[0.625rem] lg:items-center lg:justify-center lg:p-3'>
                        ...
                        <div className='lg:flex lg:items-center lg:gap-[0.625rem]'>
                            <a className='lg:p-[0.313rem]' href='/instagram'><img src='/icons/instagram.svg'></img></a>
                            <a className='lg:p-[0.313rem]' href='/youtube'><img src='/icons/youtube.svg'></img></a>
                            <a className='lg:p-[0.313rem]' href='/facebook'><img src='/icons/facebook.svg'></img></a>
                            <a className='lg:p-[0.313rem]' href='/twitter'><img src='/icons/twitter.svg'></img></a>
                        </div>
                    </div>
                </div>
            </div>
            <div className='flex flex-wrap h-[33rem] px-6
                ...
                <div className='w-full order-3
                    ...
                    <div className='flex flex-col gap-[1.875rem]
                        ...
                        <a className='hidden
                                    lg:link-style lg:flex lg:gap-1' onClick={toggleDropdown}>Shop<img src="/icons/dropdown.svg"></img></a>
                        <a className='hidden
                ...
                <div className='w-1/2 order-2 flex items-center gap-[0.5rem]
                    ...
                    <a href='/search'><img className='hidden lg:navbar-actions' src='/icons/search.svg'></img></a>
                    <a href='/search'><img className='block lg:hidden' src='/icons/search-mobile.svg'></img></a>

                    <a href='/cart'><img className='hidden lg:navbar-actions' src='/icons/cart.svg'></img></a>
                    <a href='/cart'><img className='block lg:hidden' src='/icons/cart-mobile.svg'></img></a>

                    <a href='/favorites'><img className='hidden lg:navbar-actions' src='/icons/heart.svg'></img></a>
                    <a href='/menu'><img className='block lg:hidden' src='/icons/hamburger.svg'></img></a>
                </div>
            </div>
        </div >
    </>
