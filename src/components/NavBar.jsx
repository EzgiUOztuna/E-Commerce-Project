            ...
            <div className='hidden
                ...
                <div className='hidden
                    ...
                    <div className='lg:flex lg:w-[9.063rem] lg:h-11 lg:items-center lg:gap-[0.313rem] lg:p-[0.625rem] lg:rounded-[0.313rem]'>{/*navbar-phone*/}
                        <img className='lg:w-4 lg:h-4' src="public/icons/phone.svg"></img>{/*phone-img*/}
                    ...
                    <div className='lg:w-[16.25rem] lg:h-[2.75rem] lg:flex lg:items-center lg:gap-[0.3125rem] lg:p-[0.625rem] lg:rounded-[0.3125rem]'>{/*navbar-email*/}
                        <img className='lg:w-4 lg:h-4' src="public/icons/email.svg"></img>{/*email-img*/}
                ...
                <div className='lg:flex lg:gap-[0.625rem] lg:items-center lg:justify-center'>{/*navbar-col-right*/}
                    ...
                    <div className='lg:flex lg:items-center lg:gap-[0.625rem]'>{/*social-media*/}
                        <a className='lg:p-[0.313rem]' href='/instagram'><img src='public/icons/instagram.svg'></img></a>
                        <a className='lg:p-[0.313rem]' href='/youtube'><img src='public/icons/youtube.svg'></img></a>
                        <a className='lg:p-[0.313rem]' href='/facebook'><img src='public/icons/facebook.svg'></img></a>
                        <a className='lg:p-[0.313rem]' href='/twitter'><img src='public/icons/twitter.svg'></img></a>
                    </div>
                </div>
            </div>
            ...
            <div className='flex flex-wrap h-[33rem] px-6
                ...
                <div className='w-full order-3
                    ...
                    <div className='flex flex-col gap-[1.875rem]
                        ...
                        <a className='hidden
                                    lg:link-style lg:flex lg:gap-1' onClick={toggleDropdown}>Shop<img src="public/icons/dropdown.svg"></img></a>{/*dropbtn*/}
                        <a className='hidden
                ...
                <div className='w-1/2 order-2 flex items-center gap-[0.5rem]
                    ...
                    <a href="/login" className='lg:navbar-actions'>{/*login-register*/}
                        <img className='hidden lg:block' src='public/icons/user.svg'></img>
                        <img className='block lg:hidden' src='public/icons/user-mobile.svg'></img>
                        <p className='hidden
                    ...
                    <a href='/search'><img className='hidden lg:navbar-actions' src='public/icons/search.svg'></img></a>{/*search*/}
                    <a href='/search'><img className='block lg:hidden' src='public/icons/search-mobile.svg'></img></a>

                    <a href='/cart'><img className='hidden lg:navbar-actions' src='public/icons/cart.svg'></img></a>{/*cart*/}
                    <a href='/cart'><img className='block lg:hidden' src='public/icons/cart-mobile.svg'></img></a>

                    <a href='/favorites'><img className='hidden lg:navbar-actions' src='public/icons/heart.svg'></img></a>{/*heart*/}
                    <a href='/menu'><img className='block lg:hidden' src='public/icons/hamburger.svg'></img></a>{/*hamburger*/}
                </div>
