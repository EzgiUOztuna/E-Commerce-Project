...
export default function ShopCards({ index }) {
    return <>
        {/* </><div>-ShopCards</div>; */}
        <div className="bg-[#FAFAFA] h-[115rem] py-16 gap-12 flex flex-col items-center
            ...
            <div className="flex flex-col gap-[0.625rem] items-center
                            lg:w-[38rem] ">
                <h3 className="font-montserrat font-bold text-base leading-8 tracking-[0.1px] text-[#252B42] text-center 
            ...
            <div className="gap-[1.875rem] flex flex-col
                ...
                {shopCardsData.slice(0, 2).map((item, index) => (
                    ...
                    lg:w-[31.87rem] lg:h-31.25rem "
                        style={{ backgroundImage: `url(${window.innerWidth >= 1024 ? item.desktopImage : item.mobileImage})` }}>
                ...
                <div className="flex flex-col gap-4">
                    <div className="bg-cover bg-no-repeat lg:w-60 lg:h-[15.12rem]" style={{ backgroundImage: "url(src/assets/images/accessories-bg-cover.svg)" }}>
                    ...
                    <div className="bg-cover bg-no-repeat lg:w-60 lg:h-[15.12rem]" style={{ backgroundImage: "url(src/assets/images/kids-bg-cover.svg)" }}>
                        <button className="bg-[#FFFFFF]
