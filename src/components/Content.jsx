        ...
        {contentPageCarouselData.map((item, index) => (
            <div key={index}
                className={`${currentIndex === index ? 'block' : 'hidden'}
                            bg-cover bg-no-repeat box-border
                            lg:h-[709px] 
                        `} style={{
                ...
                <div className='font-montserrat text-[#FFFFFF] flex flex-col items-center gap-[2.18rem] pt-[8rem] justify-center
