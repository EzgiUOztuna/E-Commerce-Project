            ...
            <div key={index}
                ...
                <div className='flex flex-col items-center gap-[2.18rem] pt-[10rem]
                    ...
                    <h5 className='font-montserrat font-bold text-base leading-6 tracking-[0.1px] m-0 text-[#FFFFFF]
                                   '>{item.h5}</h5>
                    <h1 className='font-montserrat font-bold text-4xl leading-[3.125rem] tracking-[0.2px] lg:m-0 text-[#FFFFFF] w-[16.75rem] text-center
                                   lg:text-[3.625rem] lg:leading-[5rem] lg:w-[35.62rem] lg:text-left'>{item.h1}</h1>
                    <h4 className='w-[13rem] font-montserrat font-normal text-sm leading-[1.875rem] tracking-[0.2px] text-center text-[#FAFAFA] m-0
                    ...
                    <button className='w-[13.813rem] h-[3.875rem] gap-[0.625rem] bg-[#2DC071] prx-10 rounded-[0.3125rem] border-none
                        ...
                        <h3 className='font-montserrat font-bold text-base leading-8 tracking-[0.00625rem] text-center m-0 text-white'>{item.h3}</h3>
                    </button>
                </div>
