...
export default function ContactPage() {
    return <>
        <div className='font-montserrat lg:bg-[url("src/assets/images/contactPageImg/background.png")] lg:bg-no-repeat lg:h-[882px]
                        xl:bg-cover'>
            <div className='flex flex-wrap px-6 items-center bg-[#F6F6F6]
                            lg:w-[73.5rem]  lg:flex lg:flex-nowrap lg:items-center lg:justify-between lg:mx-auto lg:pt-4 lg:bg-[#FFFFFF]'>
            ...
            <div className='flex gap-20 justify-around lg:py-28'>
                <div className='flex flex-col gap-7  lg:w-[37.5rem]'>
                    ...
                    <div className='flex flex-col gap-4 font-bold text-2xl leading-8 tracking-[0.1px] text-[#252B42]'>
